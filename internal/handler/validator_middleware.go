...
func ValidateJSON(obj interface{}) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := c.ShouldBindJSON(obj); err != nil {
			ResponseError(c, http.StatusBadRequest, "请求参数格式错误: "+err.Error())
			c.Abort()
			return
		}
...
func ValidateQuery(obj interface{}) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := c.ShouldBindQuery(obj); err != nil {
			ResponseError(c, http.StatusBadRequest, "查询参数格式错误: "+err.Error())
			c.Abort()
			return
		}
...
func ValidateURI(obj interface{}) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := c.ShouldBindUri(obj); err != nil {
			ResponseError(c, http.StatusBadRequest, "URI参数格式错误: "+err.Error())
			c.Abort()
			return
		}
...
func ValidateAndBind(c *gin.Context, obj interface{}) bool {
	...
	if err != nil {
		ResponseError(c, http.StatusBadRequest, "读取请求体失败: "+err.Error())
		return false
	}
